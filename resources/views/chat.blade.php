...
<main class="flex items-start min-h-screen">
    ...
    <div class="flex flex-col h-screen bg-[#f5f7fb] w-full">
        ...
        <x-dashboard-header image="{{session('user_avatar')}}" page="Partner" />
        <main class="flex-grow p-4 overflow-y-auto">
            <div id="chat-log" class="space-y-4">
                <div class="flex items-start gap-3 justify-start">
                    <img src="/sobat-belajar.svg" class="w-8 h-8 rounded-full" alt="AI">
            ...
            <form id="chat-form" class="w-full">
                <div class="relative">
                    ...
                    <button type="submit" id="submit-button"
                        class="absolute right-3 top-1/2 rotate-90 -translate-y-1/2 w-10 h-10 bg-blue-500 hover:bg-blue-600 rounded-full flex items-center justify-center transition-colors disabled:bg-gray-400">
