...
@section('content')
    <main class="flex items-start bg-[#f5f7fb]">
        ...
        <section class=" w-full relative mb-10">
            <x-dashboard-header image="/PP.jpg" />
            ...
            <div class="px-10">
                ...
                <div class="grid grid-cols-4 gap-5">
                    <x-course-card image="/cover-corse.png" title="Tutorial menggunakan Figma untuk pemula"
                        category="teknologi" total="14" level="sekolah menengah atas" link="/kursus/figma" />
