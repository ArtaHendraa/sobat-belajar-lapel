                    ...
                    <div class="border border-black/10 bg-white p-3.5 rounded-2xl flex flex-col gap-2.5">
                        <div class="rounded-xl">
                            <img src="/cover-corse.png"
                                class="rounded-xl aspect-video object-cover border border-black/20" alt="">
                        </div>
                        <h1 class="font-semibold">Tutorial menggunakan figma untuk pemula</h1>
                        <span class="font-semibold capitalize text-[#8B93FF] text-sm">teknologi</span>
                        ...
                        <a href=""
                            class="capitalize bg-[#5755FE] inline-block text-white w-full text-center py-3 rounded-xl font-semibold">lanjutkan</a>
                    </div>
